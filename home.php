...
<div class="about-area ptb-100">
    <div class="container">
        <div class="row align-items-center justify-content-center">
            ...
            <div class="col-lg-6">
                <div class="about-img">
                    <img src="<?php bloginfo('template_directory'); ?>/assets/images/about/about-img1.jpg" alt="About Images">
                    <div class="sub-content">
                        <img src="<?php bloginfo('template_directory'); ?>/assets/images/about/about-img2.jpg" alt="About Images">
                        <div class="content">
                            <h3>4.5k</h3>
...
<section class="services-area pt-100 pb-70">
    ...
    <div class="service-shape">
        <img src="<?php bloginfo('template_directory'); ?>/assets/images/shape/service-shape1.png" alt="Images">
    </div>
</section>
<!-- Services Area End -->
    ...
    <div class="container">
        ...
        <div class="row pt-45">
            <div class="col-lg-4 col-md-6">
                <div class="build-item">
                    <a href="case-details.html">
                        <img src="<?php bloginfo('template_directory'); ?>/assets/images/build/build-img1.jpg" alt="Images">
                    </a>
                    <div class="content">
            ...
            <div class="col-lg-4 col-md-6">
                <div class="build-item">
                    <a href="case-details.html">
                        <img src="<?php bloginfo('template_directory'); ?>/assets/images/build/build-img2.jpg" alt="Images">
                    </a>
                    <div class="content">
            ...
            <div class="col-lg-4 col-md-6 offset-lg-0 offset-md-3">
                <div class="build-item">
                    <a href="case-details.html">
                        <img src="<?php bloginfo('template_directory'); ?>/assets/images/build/build-img3.jpg" alt="Images">
                    </a>
                    <div class="content">
        ...
        <div class="row align-items-center">
            ...
            <div class="col-lg-6">
                <div class="call-us-img">
                    <img src="<?php bloginfo('template_directory'); ?>/assets/images/call-us/call-us-img1.png" alt="Images">
                    <div class="call-shape">
                        <div class="shape1">
                            <img src="<?php bloginfo('template_directory'); ?>/assets/images/call-us/call-shap2.png" alt="Images">
                        </div>

                        <div class="shape2 shape2-rs">
                            <img src="<?php bloginfo('template_directory'); ?>/assets/images/call-us/call-shap3.png" alt="Images">
                        </div>
                    </div>
                </div>
            </div>
    ...
    <div class="container">
        <div class="brand-slider owl-carousel owl-theme">
            <div class="brand-item">
                <img src="<?php bloginfo('template_directory'); ?>/assets/images/brand-logo/brand-logo1.png" class="brand-logo-one" alt="Images">
                <img src="<?php bloginfo('template_directory'); ?>/assets/images/brand-logo/brand-style1.png" class="brand-logo-two" alt="Images">
            </div>
            <div class="brand-item">
                <img src="<?php bloginfo('template_directory'); ?>/assets/images/brand-logo/brand-logo2.png" class="brand-logo-one" alt="Images">
                <img src="<?php bloginfo('template_directory'); ?>/assets/images/brand-logo/brand-style2.png" class="brand-logo-two" alt="Images">
            </div>
            <div class="brand-item">
                <img src="<?php bloginfo('template_directory'); ?>/assets/images/brand-logo/brand-logo3.png" class="brand-logo-one" alt="Images">
                <img src="<?php bloginfo('template_directory'); ?>/assets/images/brand-logo/brand-style3.png" class="brand-logo-two" alt="Images">
            </div>
            <div class="brand-item">
                <img src="<?php bloginfo('template_directory'); ?>/assets/images/brand-logo/brand-logo4.png" class="brand-logo-one" alt="Images">
                <img src="<?php bloginfo('template_directory'); ?>/assets/images/brand-logo/brand-style4.png" class="brand-logo-two" alt="Images">
            </div>
            <div class="brand-item">
                <img src="<?php bloginfo('template_directory'); ?>/assets/images/brand-logo/brand-logo5.png" class="brand-logo-one" alt="Images">
                <img src="<?php bloginfo('template_directory'); ?>/assets/images/brand-logo/brand-style5.png" class="brand-logo-two" alt="Images">
            </div>
            <div class="brand-item">
                <img src="<?php bloginfo('template_directory'); ?>/assets/images/brand-logo/brand-logo3.png" class="brand-logo-one" alt="Images">
                <img src="<?php bloginfo('template_directory'); ?>/assets/images/brand-logo/brand-style3.png" class="brand-logo-two" alt="Images">
    ...
    <div class="container">
        ...
        <div class="clients-slider owl-carousel owl-theme pt-45">
            <div class="clients-content">
                <div class="content">
                    <img src="<?php bloginfo('template_directory'); ?>/assets/images/clients-img/clients-img1.jpg" alt="Images">
            ...
            <div class="clients-content">
                <div class="content">
                    <img src="<?php bloginfo('template_directory'); ?>/assets/images/clients-img/clients-img2.jpg" alt="Images">
                    <i class='bx bxs-quote-alt-left'></i>
                    <h3>Alin Decros</h3>
            ...
            <div class="clients-content">
                <div class="content">
                    <img src="<?php bloginfo('template_directory'); ?>/assets/images/clients-img/clients-img3.jpg" alt="Images">
                    <i class='bx bxs-quote-alt-left'></i>
                    <h3>Elen Musk</h3>
        ...
        <div class="row pt-45">
                ...
                <div class="blog-card">
                    <div class="blog-img">
                        <a href="blog-details.html">
                            <img src="<?php bloginfo('template_directory'); ?>/assets/images/blog/blog-img1.jpg" alt="Blog Images">
                        </a>
                        <div class="blog-tag">
                            <h3>11</h3>
                            <span>Dec</span>
            ...
            <div class="col-lg-4 col-md-6">
                <div class="blog-card">
                    <div class="blog-img">
                        <a href="blog-details.html">
                            <img src="<?php bloginfo('template_directory'); ?>/assets/images/blog/blog-img2.jpg" alt="Blog Images">
                        </a>
                        <div class="blog-tag">
                            <h3>14</h3>
                            <span>Dec</span>
            ...
            <div class="col-lg-4 col-md-6 offset-lg-0 offset-md-3">
                <div class="blog-card">
                    <div class="blog-img">
                        <a href="blog-details.html">
                            <img src="<?php bloginfo('template_directory'); ?>/assets/images/blog/blog-img3.jpg" alt="Blog Images">
                        </a>
                        <div class="blog-tag">
                            <h3>17</h3>
                            <span>Dec</span>
