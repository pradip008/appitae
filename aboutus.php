...
?>
 ...
 <div class="inner-banner">
            ...
            <div class="inner-shape">
                <img src="<?php bloginfo('template_directory'); ?>/assets/images/shape/inner-shape.png" alt="Images">
            </div>
        </div>
        <!-- Inner Banner End -->
                ...
                <div class="row">
                    ...
                    <div class="col-lg-6">
                        <div class="choose-img">
                            <img src="<?php bloginfo('template_directory'); ?>/assets/images/choose-img.jpg" alt="Images">
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="container">
                <div class="brand-slider owl-carousel owl-theme">
                    <div class="brand-item">
                        <img src="<?php bloginfo('template_directory'); ?>/assets/images/brand-logo/brand-style1.png" alt="Images">
                    </div>
                    <div class="brand-item">
                        <img src="<?php bloginfo('template_directory'); ?>/assets/images/brand-logo/brand-style2.png" alt="Images">
                    </div>
                    <div class="brand-item">
                        <img src="<?php bloginfo('template_directory'); ?>/assets/images/brand-logo/brand-style3.png" alt="Images">
                    </div>
                    <div class="brand-item">
                        <img src="<?php bloginfo('template_directory'); ?>/assets/images/brand-logo/brand-style4.png" alt="Images">
                    </div>
                    <div class="brand-item">
                        <img src="<?php bloginfo('template_directory'); ?>/assets/images/brand-logo/brand-style5.png" alt="Images">
                    </div>
                    <div class="brand-item">
                        <img src="<?php bloginfo('template_directory'); ?>/assets/images/brand-logo/brand-style3.png" alt="Images">
                    </div>
        ...
        <div class="counter-area pt-100 pb-70">
            ...
            <div class="counter-shape">
                <div class="shape1">
                    <img src="<?php bloginfo('template_directory'); ?>/assets/images/shape/shape1.png" alt="Images">
                </div>
                <div class="shape2">
                    <img src="<?php bloginfo('template_directory'); ?>/assets/images/shape/shape2.png" alt="Images">
                </div>
            </div>
        </div>
        <!-- Counter Area End -->
