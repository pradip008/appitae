            ...
            <div class="container">
                        ...
                        <div class="col-lg-4 col-sm-6">
                            <div class="footer-widget">
                                <div class="footer-logo">
                                    <a href="index.html">
                                        <img src="<?php bloginfo('template_directory'); ?>/assets/images/logos/footer-logo.png" alt="Images">
                                    </a>
                                </div>
                                <p>
                            ...
                            <div class="footer-widget">
                                ...
                                <ul class="footer-contact-list">
                                    ...
                                    <li>
                                        ...
                                        <div class="content">
                                            <a href="tel:+4498753452435">
                                                +44 9875 3452 435
                                            </a>
                                            <br>
                                            <a href="tel:+4498755767536">
                                                +44 9875 5767 536
                                            </a>
                                        </div>
                                    </li>
                ...
                <div class="copy-right-area">
                    <div class="copy-right-text">
                        <p>
                            Copyright © <script>document.write(new Date().getFullYear())</script> Appitae.com | All Rights Reserved. 
                        </p>
                    </div>
                </div>
            </div>
